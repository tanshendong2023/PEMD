...
This script is part of a computational framework designed to perform high-throughput
molecular dynamics (MD) simulations for the study of polymer electrolyte systems in
energy storage applications. The focus is on automating the simulation process to
efficiently explore a wide range of polymer structures and compositions, thus aiding
in the identification and optimization of novel polymer electrolytes with superior
