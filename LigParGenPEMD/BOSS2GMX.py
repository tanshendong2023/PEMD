...
from LigParGenPEMD.BOSSReader import ucomb,pairing_func,bossPdbAtom2Element,bossElement2Mass
from LigParGenPEMD.BOSSReader import Refine_PDB_file,get_coos_from_pdb
import pickle
import pandas as pd
import numpy as np
...
def boss2gmx(resid, molecule_data, pdb_file, ln):
    types, Qs, num2opls, st_no, num2typ2symb = bossData(
        molecule_data)
    itpf = open('{}_N{}.itp'.format(resid, ln), 'w+')
    itpf.write("""
